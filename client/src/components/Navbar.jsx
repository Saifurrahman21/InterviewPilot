      ...
      >
        ...
        <div className="flex items-center gap-6 relative">
            ...
            {showCreditPopup && (
              <div className="absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50">
                <p className="text-sm text-gray-700 mb-4">
                  You have {userData?.credits || 0} credits available.
                </p>
                <button
                  onClick={() => navigate("/pricing")}
                  className="w-full bg-black text-white py-2 rounded-xl font-sm text-center hover:bg-gray-700 transition-all duration-300"
                >
                  Buy More Credits
                </button>
              </div>
          ...
          <div className="relative">
            ...
            {showUserPopup && (
              <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded p-4 z-50">
